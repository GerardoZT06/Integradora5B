        ...
        <ScrollView style={styles.cardContainer}>
          ...
          <Card containerStyle={styles.card}>
            ...
            <View style={styles.cardContent}>
              ...
              <Text style={styles.description}>En este curso, exploraremos los secretos detrás de los sabores exquisitos y las técnicas culinarias. Desde las bases fundamentales hasta las recetas más innovadoras.</Text>
            </View>
          </Card>
        </ScrollView>
      </View>
